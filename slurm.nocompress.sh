...
#SBATCH -J intml_8gpu
#SBATCH -o /ibex/scratch/hoc0a/imagenet18_collective_scheduling_compress/logs/nocompress_%J.%N.seed.%A_%a.gpu.out
...
export CNAT_COMPRESS=0
conda activate /ibex/scratch/hoc0a/imagenet18_collective_scheduling_compress/env
LOG_DIR=/ibex/scratch/hoc0a/imagenet18_collective_scheduling_compress/logs/nocompress_${SLURM_JOB_ID}_SEED_${SLURM_ARRAY_TASK_ID}
mkdir -p $LOG_DIR
